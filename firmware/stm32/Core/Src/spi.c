...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = LCD_SCK_Pin|LCD_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
  ...
  /* USER CODE END SPI4_MspInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(RADIO_SCK_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END SPI5_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = ETH_MOSI_Pin|ETH_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI5;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB4     ------> SPI1_MISO
    */
    HAL_GPIO_DeInit(LCD_MOSI_GPIO_Port, LCD_MOSI_Pin);

    HAL_GPIO_DeInit(GPIOB, LCD_SCK_Pin|LCD_MISO_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(RADIO_SCK_GPIO_Port, RADIO_SCK_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PA12     ------> SPI5_MISO
    */
    HAL_GPIO_DeInit(ETH_SCK_GPIO_Port, ETH_SCK_Pin);

    HAL_GPIO_DeInit(GPIOA, ETH_MOSI_Pin|ETH_MISO_Pin);
